...
```{r subset_seurat}
# multiplet barcodes
barcodes1 <- readRDS("../../rObjects/pass1_recluster_neurons_barcodes_to_remove.rds")
barcodes2 <- readRDS("../../rObjects/pass1_recluster_astrocytes_barcodes_to_remove.rds")
barcodes3 <- readRDS("../../rObjects/pass1_recluster_oligos_barcodes_to_remove.rds")
barcodes4 <- readRDS("../../rObjects/pass1_recluster_endothelial_mural_barcodes_to_remove.rds")
barcodes5 <- readRDS("../../rObjects/pass1_recluster_microglia_barcodes_to_remove.rds")
barcodes6 <- readRDS("../../rObjects/pass1_recluster_choroid_barcodes_to_remove.rds")
barcodes7 <- readRDS("../../rObjects/pass1_recluster_multiplets_barcodes_to_remove.rds")
...
mouse <- subset(mouse_annotated, keep == TRUE)
...
# cleanup
remove(mouse_annotated, barcodes1, barcodes2, barcodes3, barcodes4, barcodes5, 
...
saveRDS(mouse_integrated, 
        file = "../../rObjects/pass2_harmony_seurat_obj.rds",
        compress = FALSE)
remove(mouse_merged)
gc()
```
...
canonical_markers <- c(
  ...
  "Meg3", "Snap25", "Slc17a6","Slc17a7", "Gad1", "Gad2", # Neurons
  "Pdgfra", "Cspg4", "Olig1", "Olig2", "Tnr",         # OPCs
  "Mog", "Opalin", "Mal", "Mag", "Mbp"                # Oligodendrocytes
)

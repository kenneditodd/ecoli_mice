...
pdf(paste0(path, "umap_split_group.pdf"), width = 8, height = 10)
umap1
dev.off()

pdf(paste0(path, "umap_split_group2.pdf"), width = 14, height = 10)
umap2
dev.off()
...
pdf(paste0(path, "umap_split_treatment.pdf"), width = 8, height = 4)
umap4
dev.off()
...
pdf(paste0(path, "umap_split_timepoint.pdf"), width = 8, height = 4)
umap7
dev.off()

pdf(paste0(path, "umap_split_age.pdf"), width = 8, height = 4)
umap8
dev.off()
...
all_clusters <- unique(mouse.annotated$annotated_clusters)

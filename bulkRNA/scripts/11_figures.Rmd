...
upset_gene <- upset_gene + ggtitle(paste0("E.2D.Y vs S.2D.Y, FDRq < ", format(thresh, nsmall = 2),
                                          ", |LFC| > ", format(myLfc, nsmall = 2)))

# save
pdf(paste0("../results/filtering_comparison/E.2D.Y_vs_S.2D.Y_FDRq_", format(thresh, nsmall = 2), 
...
write.table(x = exclusive_intersection_df,
            file = paste0("../results/filtering_comparison/E.2D.Y_vs_S.2D.Y_FDRq_", 

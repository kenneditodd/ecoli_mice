...
# variables
out <- "../../results/with_integration/pass1/reclusters/microglia/"
keep_clusters <- c("Microglia")
...
seurat_subset <- SCTransform(seurat_subset, verbose = FALSE)
...
seurat_subset <- IntegrateLayers(object = seurat_subset,
...
## UMAP
```{r}
seurat_subset$seurat_clusters <- seurat_subset$SCT_snn_res.0.1
...
pdf(paste0(out, "canonical_violin.pdf"), width = 5, height = 6)
v2
dev.off()

remove(v1,v2,top3,markers)
```

...
E2DY_vs_S2DY <- read.delim(
  paste0("../results/sex_specific_filtering_but_both_sexes_comparison/", 
...
# save
pdf(paste0("../results/sex_specific_filtering_but_both_sexes_comparison/",
...
write.table(x = exclusive_intersection_df,
            file = paste0("../results/sex_specific_filtering_but_both_sexes_comparison/",
                          model, "upset/E.2D_vs_S.2D_both_sexes_FDRq_", 

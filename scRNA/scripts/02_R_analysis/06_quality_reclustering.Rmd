...
# variables
out <- "../../results/without_integration/recluster_group1/"
keep_clusters <- c("Endothelial", "?Fibro?Peri?Endo?", "Astrocytes / Endothelial",
                   "Astrocytes", "Pericytes & SMCs")
...
# Recluster group 1
- Group 1 recluster: Endothelial, ?Fibro?Peri?Endo?, Astrocytes / Endothelial, Astrocytes, Pericytes & SMCs \
## Subset
...
seurat_subset <- CreateSeuratObject(counts, 
                                    meta.data = seurat_subset@meta.data[,c(1:24,33,34)])
